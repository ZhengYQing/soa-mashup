...
function clicked(num) {
    switch (num) {
        case 1:
            window.location.href = "../Home/Index?uid=" + uid + "&user_name=" + name;
            //alert("you click1");
            break;
        case 2:
            window.location.href = "../Main/Search?uid=" + uid + "&user_name=" + name;
            //alert("you click2");
            break;
        case 3:
            window.location.href = "../Discussion/BlogMain?uid=" + uid + "&user_name=" + name;
            //alert("you click3");
            break;
    }
}